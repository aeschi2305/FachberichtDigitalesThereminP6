...
Um nun zu sagen, wann ein Unterschied in der Frequenz vom Gehör wahrgenommen wird, kommt es ganz auf die Person drauf an. Als Faustformel kann gesagt werden, dass zwei aufeinanderfolgende Töne mit etwa \SI{6}{Cent} unterschied vom Gehör registriert wird. Jedoch wann ein Ton als ''nicht getroffen`` empfunden wird ist schwierig zu sagen.\cite{Cent}
